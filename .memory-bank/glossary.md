...
| Context guard | Compress-ShpChatContext eliding the oldest tool-role message content before a chat turn to keep the estimated prompt within $script:DefaultMaxContextWindowTokens. | context trimmer, history pruner |
