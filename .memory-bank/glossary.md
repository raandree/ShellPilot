...
| Todo list | The model's per-turn ordered checklist of sub-tasks (items of id/title/status) maintained via the manage_todo_list tool (Invoke-Shp -EnableTodoList) and returned on the result's TodoList. | task tracker, todo tracker, agenda |
