...
- The proof of concept is functional end to end (auth, model list, and
  completion with tools, usage, and cost).
- No automated tests, no build pipeline, and no CHANGELOG yet.

## What is left

- Resolve the open decisions in specs/001-open-decisions.md.
- Write per-capability specs.
- Choose the build framework and scaffold it.
